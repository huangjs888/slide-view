...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util */ "./node_modules/@huangjs888/gesture/es/util.js");
/*
 * @Author: Huangjs
 * @Date: 2023-02-13 15:22:58
 * @LastEditors: Huangjs
...
function started(event) {
  const {
    points,
    isFirst
  } = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getEventPoints)(event, true);
  if (!points) {
    return;
  }
  ...
  if (pointer1 && pointer0) {
    ...
    newEvent.getPoint = () => (0,_util__WEBPACK_IMPORTED_MODULE_1__.getCenter)(pointer0.current, pointer1.current);
  ...
  // 单指start
    ...
    if (singleTapTimer && firstPointer && (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDistance)(firstPointer.current, pointer0.current) < this.doubleTapDistance) {
...
function moved(event) {
  const {
    points
  } = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getEventPoints)(event);
  if (!points) {
    return;
  }
  event.preventDefault();
  ...
  const pointer0 = this._pointer0;
  const pointer1 = this._pointer1;
  if (pointer0 && (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDistance)(pointer0.start, pointer0.current) > this.touchMoveDistance || pointer1 && (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDistance)(pointer1.start, pointer1.current) > this.touchMoveDistance) {
    ...
    if (pointer1 && pointer0) {
      ...
      // 双指平移
      const eCenter = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getCenter)(current0, current1);
      const mCenter = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getCenter)(previous0, previous1);
      const sCenter = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getCenter)(start0, start1);
      newEvent.getPoint = whichOne => whichOne === 'start' ? sCenter : whichOne === 'previous' ? mCenter : eCenter;
      newEvent.direction = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDirection)(mCenter, eCenter);
      newEvent.moveDirection = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDirection)(sCenter, eCenter);
      ...
      // 只有双指滑动时才会触发下面事件
      const eDistance = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDistance)(current0, current1);
      const mDistance = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDistance)(previous0, previous1);
      const sDistance = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDistance)(start0, start1);
      if (sDistance > 0 && eDistance > 0 && mDistance > 0) {
        // 双指缩放
        newEvent.scale = eDistance / mDistance;
        newEvent.moveScale = eDistance / sDistance;
      }
      const eAngle = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getAngle)(current0, current1);
      const mAngle = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getAngle)(previous0, previous1);
    ...
    // 单指移动
      ...
      newEvent.direction = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDirection)(previous, current);
      newEvent.moveDirection = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDirection)(start, current);
...
function ended(event) {
  ...
  if (this._pointer0) {
    ...
    const start = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getCenter)(this._pointer0.start, this._pointer1 ? this._pointer1.start : pointer1 ? pointer1.start : []);
    const previous = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getCenter)(this._pointer0.previous, this._pointer1 ? this._pointer1.previous : pointer1 ? pointer1.previous : []);
    const current = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getCenter)(this._pointer0.current, this._pointer1 ? this._pointer1.current : pointer1 ? pointer1.current : []);
    newEvent.getPoint = whichOne => whichOne === 'start' ? start : whichOne === 'previous' ? previous : current;
  ...
  // 全部拿开
    ...
    const start = pointer1 ? (0,_util__WEBPACK_IMPORTED_MODULE_1__.getCenter)(pointer0.start, pointer1.start) : pointer0.start;
    const previous = pointer1 ? (0,_util__WEBPACK_IMPORTED_MODULE_1__.getCenter)(pointer0.previous, pointer1.previous) : pointer0.previous;
    const current = pointer1 ? (0,_util__WEBPACK_IMPORTED_MODULE_1__.getCenter)(pointer0.current, pointer1.current) : pointer0.current;
    newEvent.getPoint = whichOne => whichOne === 'start' ? start : whichOne === 'previous' ? previous : current;
    if (!this._preventTap) {
    ...
    if (this._swipePoints) {
      ...
      if (Date.now() - endPos.timestamp <= this.raiseDuration) {
        ...
        const velocity = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getVelocity)(endPos.timestamp - startPos.timestamp, (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDistance)(startPos.point, endPos.point));
        // swipe速率需要大于swipeVelocity，否则忽略不计，不视为swipe
        if (velocity > this.swipeVelocity) {
          // 滑动方向与x夹角
          const angle = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getAngle)(startPos.point, endPos.point);
          // 惯性的方向
          newEvent.direction = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getDirection)(startPos.point, endPos.point);
          newEvent.angle = angle;
          ...
          newEvent.swipeComputed = (factor, _velocity = velocity) => {
            ...
            const [stretchX, stretchY] = (0,_util__WEBPACK_IMPORTED_MODULE_1__.getVector)(distance, angle);
            return {
              duration,
              // swipe速率减到0花费的时间
              stretchX,
...
class Gesture extends _event__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(element, options) {
    ...
    this.wheelDelay = (0,_util__WEBPACK_IMPORTED_MODULE_1__.fixOption)(wheelDelay, 350, 1);
    this.longTapInterval = (0,_util__WEBPACK_IMPORTED_MODULE_1__.fixOption)(longTapInterval, 750, 1);
    this.doubleTapInterval = (0,_util__WEBPACK_IMPORTED_MODULE_1__.fixOption)(doubleTapInterval, 250, 1);
    this.doubleTapDistance = (0,_util__WEBPACK_IMPORTED_MODULE_1__.fixOption)(doubleTapDistance, 30, 1);
    this.touchMoveDistance = (0,_util__WEBPACK_IMPORTED_MODULE_1__.fixOption)(touchMoveDistance, 3, 0);
    this.swipeVelocity = (0,_util__WEBPACK_IMPORTED_MODULE_1__.fixOption)(swipeVelocity, 0.3, 0);
    this.swipeDuration = (0,_util__WEBPACK_IMPORTED_MODULE_1__.fixOption)(swipeDuration, 100, 1);
    this.raiseDuration = (0,_util__WEBPACK_IMPORTED_MODULE_1__.fixOption)(raiseDuration, 100, 1);
    // 注册触摸事件
    const tmscrolled = scrolled.bind(this);
    if ((0,_util__WEBPACK_IMPORTED_MODULE_1__.isTouchable)(this.element)) {
  ...
  isTouch() {
    return (0,_util__WEBPACK_IMPORTED_MODULE_1__.isTouchable)(this.element);
  }
  destory() {
    // 解除所有事件
    super.off();
...
function getEventPoints(event, started = false) {
...
function getCenter([x0, y0], [x1, y1]) {
